...
public sealed class UpdateRoleCommandHandler : ICommandHandler<UpdateRoleCommandRequest, UpdateRoleCommandResponse>
{
    ...
    public async Task<UpdateRoleCommandResponse> Handle(UpdateRoleCommandRequest request, CancellationToken cancellationToken)
    {
        ...
        if (role.Code != request.Code)
        {
            ...
            if (checkCode != null) 
                throw new ConflictException("Bu kod daha önce kaydedilmiş!");
        }
